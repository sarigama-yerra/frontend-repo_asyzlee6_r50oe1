  ...
  return (
    <div className="py-12">
      <header className="max-w-3xl mt-10">
        ...
        <p className="mt-3 text-slate-700 dark:text-slate-300">Ideas on motion, performance, and product craft.</p>
      </header>
      <div className="grid md:grid-cols-3 gap-6 mt-10">
        {blogs.map((post)=> (
          <article key={post.id} className="bg-white/70 dark:bg-slate-800/60 backdrop-blur rounded-xl shadow-sm overflow-hidden border border-slate-200/70 dark:border-slate-700 hover:shadow-lg transition">
